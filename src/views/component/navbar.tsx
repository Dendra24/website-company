    ...
    <div className="fixed top-0 left-0 w-full bg-black shadow-md z-50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="text-2xl font-bold ">
          <Link href="/">
          <img src="/images/logo-3.png" width={90} height={'100%'} className='w-[80px] md:w-[150px]' alt="Description" />
          </Link>
        </div>
        ...
        <div
          className={`${
            isOpen ? 'block' : 'hidden'
          } absolute top-0 left-0 w-full bg-black md:static md:flex md:items-center md:space-x-8 py-6 md:py-2`}
        >
          <div className="flex justify-between items-center w-full p-4 md:hidden">
            <button
              onClick={toggleMenu}
              className="text-blue-600 focus:outline-none ml-auto"
